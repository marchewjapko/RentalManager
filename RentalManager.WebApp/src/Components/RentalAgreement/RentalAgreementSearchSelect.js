...
export default function RentalAgreementSearchSelect({isLoading, handleSearch, searchValues, setSearchValues}) {
    ...
    const handleSearchChange= (event) => {
        if(event.target.type === 'checkbox') {
            setSearchValues({
                ...searchValues, [event.target.name]: event.target.checked
            })
        } else {
            setSearchValues({
                    ...
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox
                                ...
                                onChange={handleSearchChange}
                                sx={{paddingLeft: "0px", paddingTop: "4px", paddingBottom: "4px"}}
                            />
                        }
                    />
                    <FormControlLabel
